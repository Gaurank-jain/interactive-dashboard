...
const Sidebar = ({drawerWidth, isSidebarOpen, setIsSidebarOpen, isNonMobile, user}) => {
  ...
  console.log("theme from sidebar :", theme);
        ...
        {isSidebarOpen && (
            ...
            >
                <Box width="100%" mb={"90px"}>
                 ...
                 {/* #686ffa "#cca752" */}
                <Box position="fixed" bottom="0rem" pb={"2rem"} zIndex={1} sx={{ backgroundColor: "#cca752"}}>
                    <Divider />
