...
const Dashboard = () => {
  ...
  return (
    <Box m="1.5rem 2.5rem" paddingBottom="1rem">
      <FlexBetween>
      ...
      >
        ...
        <Box
          ...
          borderRadius="0.55rem"
        >
          <Typography variant="h6" sx={{ color: theme.palette.secondary[100], textAlign:"center", fontSize: "20px" }}>
            Sales By Category
          </Typography>
          ...
          <Typography
            p="0 0.6rem"
            fontSize="0.8rem"
            sx={{ color: theme.palette.secondary[200], textAlign: "justify" }}
          >
